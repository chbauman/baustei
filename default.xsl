...
>
	...
	<xsl:template match="/">
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				<title>
					<xsl:choose>
						<xsl:when test="$fileType='Sitemap' or $fileType='RSS'">XSL?SIMPLY_STATIC_PAGE=1258 Sitemap</xsl:when>
		...
		.breadcrumb svg.back {
			...
			<body>
				...
				<xsl:call-template name="Header">
					<xsl:with-param name="title">XSL?SIMPLY_STATIC_PAGE=1258 Sitemap</xsl:with-param>
	...
	<a href=""><span>Home</span></a>
			...
			<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
					...
					<span>XSL?SIMPLY_STATIC_PAGE=1258 Sitemap</span>
				</div>		<div class="table-wrapper">
			<table cellpadding="3">
				<thead>
					<tr>
	...
	<div id="content-head">
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				and was generated on 28. März 2023 at 22:18			</p>
		</xsl:if>
	</div>
</xsl:template>
